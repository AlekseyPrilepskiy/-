    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (isWork)
            {
                ...
                {
                    case CommandToStart:
                        isWork = Arena.Start(characters);
                        break;

                    case CommandToShowInfo:
                        Arena.ShowInfo(characters);
                        break;
        ...
        class Message
        {
            ...
            public static void ShowAllFighters()
            {
        ...
        class Arena
        {
            public static bool Start(List<IDamageable> characters)
            {
                bool isFight = true;

                Message.ShowAllFighters();
            ...
            public static void ShowInfo(List<IDamageable> characters)
            {
